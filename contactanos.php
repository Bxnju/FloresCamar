...
<head>
	...
	<title>Contactanos | Flores Camar SAS</title>
...
<body>
			...
			<div class="contenedor-form">
				<div class="div_info_contacto">
					<h1>Contacta con nosotros</h1>
						<span ><b>Telefono Fijo:</b> 604 300 00 00</span>
						<span ><b>Numero de Celular:</b> +57 312 272 3581</span>
						<span ><b>Correo electronico:</b> florescamarsas@gmail.com</span>
						<span ><b>Ubicacion Local de Medellín: </b>Cra. 83 #19-32.</span>
				</div>
				<form class="form" action="./query/mandar_mensaje.php" method="POST">
					<h2>Por favor, dejanos saber quien eres:</h2>
					<input type="text" placeholder="Nombre *" name="nombres" required>
					<input type="email" placeholder="Correo *" name="correo" required>
					<input type="number" placeholder="Celular " name="celular">
					<textarea name="textarea" required>Escribe aquí tu mensaje</textarea>
					<input class="btn__1" type="submit" name="contactar">
				</form>
			</div>
...
<footer class="footer">
	<div class="footer__up">
		<div class="footer__info">
			...
			<span>Direccion Medellin: Cra. 83 #19-32.</span>
