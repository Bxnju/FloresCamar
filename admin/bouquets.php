        ...
        <?php 
		 ...
		 ?>
                    ...
                    <tr>
                        ...
                        <td> <a href="formulario_actualizar_producto.php?id=<?php echo $mostrar['id']; ?>&tipo=bouquets" title="Editar"><i class="fa-solid fa-pen-to-square"></i></a>
                            <a title="Eliminar" onClick="eliminarBouquet(<?php echo $mostrar['id'] ?>)"><i
