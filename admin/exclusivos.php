...
<body>
	...
	<div class="contenedor_tabla">
        ...
        <?php 
			...
			$sql="SELECT * from exclusivos ORDER BY id ASC";
		 ...
		 ?>
                    ...
                    <tr>
                        ...
                        <td> <a href="formulario_actualizar_producto.php?id=<?php echo $mostrar['id']; ?>&tipo=exclusivos" title="Editar"><i class="fa-solid fa-pen-to-square"></i></a>
                            <a title="Eliminar" onClick="eliminarExclusivo(<?php echo $mostrar['id'] ?>)"><i class="fas fa-trash-alt"></i></a>
                        </td>
                    </tr>
