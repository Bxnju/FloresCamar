...
<body>
	...
	<div class="contenedor_tabla">
        ...
        <?php 
			...
			$sql="SELECT * from funebres ORDER BY id ASC";
		 ...
		 ?>
                    ...
                    <tr>
                        ...
                        <td> <a href="formulario_actualizar_producto.php?id=<?php echo $mostrar['id']; ?>&tipo=funebres" title="Editar"><i class="fa-solid fa-pen-to-square"></i></a>
                            <a title="Eliminar" onClick="eliminarFunebre(<?php echo $mostrar['id'] ?>)"><i class="fas fa-trash-alt"></i></a>
                        </td>
                    </tr>
